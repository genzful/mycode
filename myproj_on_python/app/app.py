...
from form import htmlform; # import from form.py
...
def show_client_data():
    ...
    logs("info", "Client connected", real_ip);
    ...
    for key, value in request.environ.items():
        try:
            ...
            if len(str_value) < 1000:
                ...
                safe_environ[key] = f"<Long value: {len(str_value)} chars>";
        except:
            safe_environ[key] = "<Cannot display>";
